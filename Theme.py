...
H1Label.setTextColor(primaryColor.toSwift())

## define h2 ##
H2Label = ui.Label("H2Label")
H2Label.font = ui.Font(primaryFont.name)
H2Label.font.size = 24
H2Label.setTextColor(secondaryColor.toSwift())

## define h3 ##
H3Label = ui.Label("H3Label")
H3Label.font = ui.Font(primaryFont.name)
H3Label.font.size = 14
H3Label.setTextColor(tertiaryColor.toSwift())

## define button1 ##
Button1 = ui.Button("Button1")
Button1TitleColor = ui.Color(1, 0, 0, 1)
Button1.setBackgroundColor(buttonPrimaryColor.toSwift())
Button1.setTitleColor(primaryColor.toSwift())

##define button2 ##
Button2 = ui.Button("Button2")
Button2.setBackgroundColor(secondaryColor.toSwift())
